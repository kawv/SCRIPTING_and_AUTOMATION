...
class Location_Tracker:
    def __init__(self, App):
        ...
        Label(App, text="Enter number\nPlus country code",fg="white", font=("Times", 20), bg="green").place(x=150,y= 30)
        self.phone_number = Entry(App, width=16, font=("Arial", 15), relief="flat")
        self.track_button = Button(App, text="Get Number Location", bg="#22c1c3", relief="sunken")
